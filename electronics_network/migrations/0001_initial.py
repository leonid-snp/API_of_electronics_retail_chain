# Generated by Django 4.2 on 2024-09-27 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept', models.DecimalField(decimal_places=2, default=0, help_text='Введите задолженность перед поставщиком', max_digits=8, verbose_name='Задолженность')),
                ('creation_time', models.DateTimeField(auto_now_add=True, help_text='Введите время создания', verbose_name='Время')),
        ...
        migrations.AddField(
            ...
            name='supplier',
            field=models.ForeignKey(blank=True, help_text='Введите поставщика', null=True, on_delete=django.db.models.deletion.SET_NULL, to='electronics_network.factory', verbose_name='Поставщик'),
        ),
    ]
